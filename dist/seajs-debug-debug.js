 ...
 */
define("seajs/seajs-debug/1.1.1/seajs-debug-debug", [ "./seajs-debug-panel-debug", "./seajs-debug-store-debug", "./seajs-debug-config-debug", "./seajs-debug-panel-debug.css" ], function(require, exports, module) {
...
// Debug Panel Object
define("seajs/seajs-debug/1.1.1/seajs-debug-panel-debug", [ "seajs/seajs-debug/1.1.1/seajs-debug-store-debug", "seajs/seajs-debug/1.1.1/seajs-debug-config-debug" ], function(require, exports, module) {
    var doc = document, loc = location, global = this;
    var store = require("seajs/seajs-debug/1.1.1/seajs-debug-store-debug");
    var config = require("seajs/seajs-debug/1.1.1/seajs-debug-config-debug");
    var MAX_TRY = 100;
    var pollCount = 0;
    ...
    require("seajs/seajs-debug/1.1.1/seajs-debug-panel-debug.css");
    function DebugPanel() {
        this.element = null;
...
define("seajs/seajs-debug/1.1.1/seajs-debug-store-debug", [], function(require, exports, module) {
...
define("seajs/seajs-debug/1.1.1/seajs-debug-config-debug", [ "seajs/seajs-debug/1.1.1/seajs-debug-store-debug" ], function(require, exports, module) {
    var store = require("seajs/seajs-debug/1.1.1/seajs-debug-store-debug");
    // Main config
    var config = {
...
define("seajs/seajs-debug/1.1.1/seajs-debug-panel-debug.css", [], function() {
...
seajs.require("seajs/seajs-debug/1.1.1/seajs-debug-debug");
