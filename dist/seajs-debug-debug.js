 ...
 */
define("seajs/seajs-debug/1.1.1/seajs-debug-debug", [ "./panel-debug", "./store-debug", "./config-debug", "./panel-debug.css" ], function(require, exports, module) {
...
// Debug Panel Object
define("seajs/seajs-debug/1.1.1/panel-debug", [ "seajs/seajs-debug/1.1.1/store-debug", "seajs/seajs-debug/1.1.1/config-debug" ], function(require, exports, module) {
    var doc = document, loc = location, global = this;
    var store = require("seajs/seajs-debug/1.1.1/store-debug");
    var config = require("seajs/seajs-debug/1.1.1/config-debug");
    var MAX_TRY = 100;
    var pollCount = 0;
    ...
    require("seajs/seajs-debug/1.1.1/panel-debug.css");
    function DebugPanel() {
        this.element = null;
...
define("seajs/seajs-debug/1.1.1/store-debug", [], function(require, exports, module) {
...
define("seajs/seajs-debug/1.1.1/config-debug", [ "seajs/seajs-debug/1.1.1/store-debug" ], function(require, exports, module) {
    var store = require("seajs/seajs-debug/1.1.1/store-debug");
    // Main config
    var config = {
...
define("seajs/seajs-debug/1.1.1/panel-debug.css", [], function() {
